...
bbcodeParser.addBBCode('[num]{TEXT}[/num]', '<span style="color: #ff80f4; font-weight: normal;">{TEXT}</span>');
...
bbcodeParser.addBBCode('[tab{TEXT}]', '&nbsp;&nbsp;&nbsp;&nbsp;{TEXT}');
bbcodeParser.addBBCode('[br{TEXT}]', '<br{TEXT}>');
